...
features = dataset[['T2M','RH2M', 'WS10M_RANGE','T2M','LAT', 'LON', 'PRECTOT', 'PS', 'QV2M', 'T2MWET', 'TS', 'WS50M','WS10M','WS50M_RANGE','T2M_MAX','T2M_MIN','T2M_RANGE','WS10M_MAX','WS10M_MIN','WS50M_MAX','WS50M_MIN','WS50M_RANGE']]
targets = dataset[['WS10M_RANGE']]  # Features to predict: 'T2M', 'RH2M', 'WS10M_RANGE'
...
target_scaled = scaler_target.fit_transform(targets.values.reshape(-1, 1))
